...
export function CandidateApplicationDetailPage({
  ...
  const applicationQuery = useQuery({
    ...
    queryFn: () => getCandidateApplication(session!.accessToken, session!.user.id, applicationId),
  ...
  const withdrawMutation = useMutation({
    mutationFn: () =>
      withdrawCandidateApplication(session!.accessToken, session!.user.id, applicationId),
    onSuccess: async (updatedApplication) => {
      setWithdrawOpen(false);
      queryClient.setQueryData(detailQueryKey, updatedApplication);
