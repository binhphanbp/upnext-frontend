...
ARG NEXT_PUBLIC_API_URL=https://api.upnext.works/api/v1
ARG NEXT_PUBLIC_API_BASE_URL=https://api.upnext.works/api/v1
ARG NEXT_PUBLIC_SOCKET_URL=https://api.upnext.works
